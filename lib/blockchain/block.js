...
class Block {
    ...
    toHash() {
        ...
        return CryptoUtil.hash(this.index + this.previousHash + this.timestamp + this.transactionsHash + this.filter + this.nonce);
    }
    ...
    static fromJson(data) {
        ...
        R.forEachObjIndexed((value, key) => {
            ...
            } else if (key == 'filter' && value && value.type) {
                block[key] = Filter.fromJSON(value);
            } else {
                block[key] = value;
            }
        }, data);
